package com.cerdure.bookshelf.controller.event;
...
public class EventController {
    ...
    public String event(Authentication authentication, Model model) {
        ...
        model.addAttribute("bannerBooks", bookService.findDiscountTop16());
        model.addAttribute("saleBooks", bookService.findDiscountTop18());
    ...
    @GetMapping("/event/review")
    @ResponseBody
    public Map<String, Object> reviewEvent(Long bookId, Authentication authentication) {
        return null;
    }
}
